const URI = BASE_URL +"rest/V1/api/";
const API_KEY = "513bcfa2b82dc1735a07b97b7f870106";
const USERNAME = "api@bexsys";
const REALM = "Bexsys@1234";
const AUTH = "Basic YXBpQGJleHN5czpCZXhzeXNAMTIzNA=="; //"2de2be8b95bc35331783ce7b4722da59";
