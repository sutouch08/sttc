...
class Printer
{
	...
	{
		$height = empty($this->table_height) ? "" : "height:{$this->table_height}mm;";
		$thead	= "<table class='table content-table' style='table-layout:fixed; margin-bottom:2px; border:solid 1px #333; {$height}'>";
		$thead 	.= "<thead>";
	...
	public function print_row($data, $last = FALSE)
	{
		...
		$row = "<tr style='font-size:".$this->font_size."px;'>";
