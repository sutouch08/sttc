...
<div class="row">
  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
    ...
    <div class="btn-group width-100">
      <button type="button" class="btn btn-sm btn-primary width-50" id="btn-area-all" onclick="toggleAllArea(1)">ทั้งหมด</button>
      <button type="button" class="btn btn-sm width-50" id="btn-area-select" onclick="toggleAllArea(0)">เลือก</button>
    </div>
  </div>
  ...
  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
    ...
    <div class="btn-group width-100">
      ...
      <button type="button" class="btn btn-sm width-50" id="btn-role-select" onclick="toggleAllRole(0)">เลือก</button>
    </div>
  </div>
  ...
  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
    ...
    <div class="btn-group width-100">
      ...
      <button type="button" class="btn btn-sm width-50" id="btn-wh-select" onclick="toggleAllWarehouse(0)">เลือก</button>
    </div>
  </div>
...
<hr/>
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive" id="result" style="max-height:65vh;">
